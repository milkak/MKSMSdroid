...
public class PreferencesActivity extends PreferenceActivity implements IPreferenceContainer {
	...
	private static final String PREFS_THEME = "base_theme";
	/** Theme: black. */
     ...
     * @return pattern
     */
   /* static final long[] getColorPrimary(final Context context) {
    ...
    primaryColor.setColor(themeUtils.primaryColor(), Utils.resolveColor(this), R.attr.colorAccent));
    primaryColor.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
        @Override
        public boolean onPreferenceClick(Preference preference) {
            ThemeUtils themeUtils = ((ThemableActivity) getActivity()).getThemeUtils();
            new com.afollestad.cabinet.fragments.ColorChooserDialog().show(getActivity(), preference.getTitleRes(),
